      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Badge variant="outline">{Math.round(totalMinutes / 60 * 10) / 10}h</Badge>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-chart-2">{Math.round(totalMinutes / 60 * 10) / 10}</div>
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-xs">
            {weekData.map((day, index) => (
              <div 
                key={index} 
                className={`p-2 rounded ${day.isToday ? 'bg-primary/10 border border-primary/20' : 'bg-muted/30'}`}
              >
